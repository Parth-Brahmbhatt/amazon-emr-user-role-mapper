...
echo "Getting emr-user-role-mapper-application-1.3.0-SNAPSHOT-jar-with-dependencies-and-exclude-classes.jar from S3"
sudo aws s3 cp s3://${BUCKET}/${S3_PATH}/emr-user-role-mapper-application-1.3.0-SNAPSHOT-jar-with-dependencies-and-exclude-classes.jar /usr/share/aws/emr/user-role-mapper/lib/
